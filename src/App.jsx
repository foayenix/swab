      ...
      <nav style={{
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 24px', display: 'flex', alignItems: 'center', gap: 16, flexWrap: 'wrap' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginRight: 8 }}>
            <div style={{ width: 28, height: 28, background: COLORS.forest, borderRadius: 8, display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--bg)', fontStyle: 'normal', fontSize: 14, fontFamily: "'Instrument Serif', serif" }}>S</div>
            <span style={{ fontFamily: "'Instrument Serif', serif", fontSize: 22, color: COLORS.forest }}>Sanko</span>
          </div>
          <span style={{ fontSize: 11, color: 'var(--muted)', fontWeight: 500, letterSpacing: 1, textTransform: 'uppercase' }}>Experience as:</span>
